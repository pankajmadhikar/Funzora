    ...
    <AuthLayout showTrustBar>
      <div className="relative z-20 w-full max-w-[400px] sm:max-w-[420px]">
        ...
        >
          ...
          {error && (
            <div
              className="mt-4 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-center text-[13px] text-red-700"
              role="alert"
            >
              {error}
            </div>
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-3 sm:mt-6 sm:space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-2 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-[#6B7280] transition-colors hover:bg-[#F9FAFB] hover:text-[#1F2937]"
              ...
              <div className="mt-2 text-right">
                <button
                  type="button"
                  className="text-[13px] font-medium text-[#F17A7E] hover:underline"
                  onClick={() => toast('Password reset is coming soon. Contact support if you need help.')}
                >
                  Forgot Password?
                </button>
              </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <button
              type="button"
              className="flex h-12 flex-1 items-center justify-center gap-2 rounded-[10px] border border-[#E5E7EB] bg-white text-[14px] font-semibold text-[#1F2937] transition-colors hover:bg-[#F9FAFB]"
          ...
          <p className="mt-6 text-center text-[13px] text-[#6B7280] sm:mt-7 sm:text-[14px]">
            ...
            <Link to="/register" className="font-semibold text-[#F17A7E] hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
